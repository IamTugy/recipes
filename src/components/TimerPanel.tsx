...
export default function TimerPanel({ timers, onToggle, onRemove, onReset }: TimerPanelProps) {
  ...
  return (
    ...
    >
      <div className="bg-surface/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-3">
        <div className="flex items-center justify-between mb-2 px-1">
          <span className="text-xs font-semibold text-cream/50 uppercase tracking-wider">
            Active Timers
          </span>
          <span className="text-xs text-cream/30">{timers.length} running</span>
        </div>
